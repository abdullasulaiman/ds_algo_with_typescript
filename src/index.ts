import CheckRemoveEven from './array/removeEve';
import mergeTwoSortedArray from './array/mergeTwoSortedArray';
import { CheckSum, CheckSumWithHashSet } from './array/CheckSum'
...
// console.log(CheckSum([1, 21, 3, 14, 5, 60, 7, 6, 10, 17], 27));
// console.log(CheckSumWithHashSet([1, 21, 3, 14, 5, 60, 7, 6, 10, 17], 27));
